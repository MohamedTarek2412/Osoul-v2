        ...
        <div className="mt-12 grid grid-cols-1 md:grid-cols-3 gap-6 auto-rows-[220px]">
          ...
          <BentoCard className="md:col-span-2 md:row-span-2 flex flex-col justify-between">
            <div className="space-y-4">
              ...
              <div>
                ...
                <p className="text-sm sm:text-base leading-relaxed text-muted-foreground mt-3 font-light">
                  {isRtl
            ...
            <div className="mt-6 flex flex-wrap items-center gap-4 border-t border-border/60 pt-4 text-xs font-mono text-muted-foreground">
          ...
          <BentoCard className="flex items-center gap-6">
            <div className="flex-1">
              ...
              <p className="text-xs leading-relaxed text-muted-foreground mt-1.5 font-light">
                {isRtl
