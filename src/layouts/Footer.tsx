      ...
      <div className="section-container pt-16 pb-8 relative z-10">
        <div className="grid gap-12 lg:grid-cols-4 md:grid-cols-2">
          ...
          <div className="flex flex-col gap-4">
            <h3 className="text-base font-bold uppercase tracking-widest text-primary font-mono">
            ...
            <ul className="space-y-2.5">
              {footerNav.map((item) => (
                <li key={item.href}>
                  <Link
                    to={item.href}
                    className="group inline-flex items-center text-base text-muted-foreground hover:text-foreground transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary rounded-sm"
                  >
          ...
          <div className="flex flex-col gap-4">
            ...
            <div className="flex gap-3 text-base text-muted-foreground leading-relaxed mb-1">
